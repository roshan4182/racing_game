...
pygame.mixer.init()
hitSound = pygame.mixer.Sound('/Users/roshan1610/Downloads/Road Rush Game using Pygame/sound/zapsplat_impacts_car_crash_smash_head_on_23549.mp3')  # Replace 'hit.wav' with your actual sound file
